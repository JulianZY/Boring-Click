...
public class IrregularFormSample extends JFrame {
  ...
  public static String PN2;                             //静态变量获取主题名称
   //引入
  public String[] getList() throws Exception     //获取主题文件名称列表
	{
	...
	public String getFilename() throws Exception  //随机获取主题文件名
	{
	...
	//引入
  public IrregularFormSample() throws Exception {         //构造函数
    super();
  ...
  /**
    ...
    * @author Hexen
    */
  public Shape getImageShape(Image img) {               //获取主题信息及处理主题图片
